        ...
        <div className="bg-background rounded-2xl shadow-soft p-5 sm:p-6 md:p-8 space-y-5 sm:space-y-6">
          ...
          <div className="border-t border-border pt-4 space-y-3">
            ...
            <div className="text-xs text-muted-foreground bg-muted/30 p-3 rounded-lg">
              💡 {lang === 'en' ? 'Note: This is for customer accounts. Admin login is accessed by triple-tapping the logo.' :
                   lang === 'tr' ? 'Not: Bu müşteri hesapları içindir. Admin girişi logoya üç kez dokunarak erişilir.' :
