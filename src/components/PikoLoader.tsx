...
export default function PikoLoader() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-background via-background to-primary/5 p-6 overflow-hidden relative" dir={dirFor(lang)}>
