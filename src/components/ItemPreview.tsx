...
const ItemPreview = memo(function ItemPreview({ 
  ...
  if (hasVariants && !selectedSize && item.variants && item.variants.length > 0) {
    const firstSize = item.variants[0]?.size;
    if (firstSize) {
              ...
              <div className="p-5 sm:p-6 space-y-4">
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex-1 text-start">
                    <h2 id="item-preview-title" className="text-xl sm:text-2xl font-medium">
                      {itemName}
                    </h2>
                    {categoryName && (
                  ...
                  <div id="item-preview-price" className="text-xl font-medium text-primary whitespace-nowrap">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {item.variants!.map((variant) => (
                        <button
                          ...
                          `}
                        >
                          <div className="text-sm font-medium">{translateSize(variant.size, lang)}</div>
