...
import { Plus, Filter, X, Info } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between gap-4">
        ...
        <Button onClick={() => openDialog()} size="sm" className="gap-2 shrink-0" style={{ backgroundColor: '#0C6071' }}>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 pt-4 border-t">
              <h4 className="text-sm font-medium text-muted-foreground">Descriptions (Optional)</h4>
              <div>
            ...
            <div className="space-y-3 pt-4 border-t">
              ...
              <p className="text-xs text-muted-foreground">
                {lang === 'en' ? 'Add different sizes with different prices (e.g., Small, Medium, Large)' :
                 lang === 'tr' ? 'Farklı fiyatlarla farklı boyutlar ekleyin (örn. Küçük, Orta, Büyük)' :
              ...
              {formData.variants?.map((variant, index) => (
                <div key={index} className="flex gap-2 items-end">
                  ...
                  <div className="flex-1">
                    <Label className="text-xs">{t('priceWithCurrency', lang)}</Label>
                    <Input
                      type="number"
                      step="0.01"
                      value={variant.price}
